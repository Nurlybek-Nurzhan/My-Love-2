  ...
  t && Object.deepExtend(e, t),
      ...
      if (
        ...
        r.value == "random"
          ...
          : typeof r.value == "string" &&
            ((this.color = r), (this.color.rgb = Q(this.color.value)));
      (this.opacity =
    ...
    (e.fn.modes.repulseParticle = function (r) {
      if (
        ...
        var n = r.x - e.interactivity.mouse.pos_x,
          ...
          c = 100,
          u = ke((1 / d) * (-1 * Math.pow(l / d, 2) + 1) * d * c, 0, 50),
    ...
    (e.fn.vendors.init = function () {
      e.fn.retinaInit(),
        ...
        e.fn.particlesCreate(),
        e.fn.vendors.densityAutoParticles(),
        (e.particles.line_linked.color_rgb_line = Q(
...
const Ce = document.querySelector("#bg_heart");
function ze(s, t) {
...
const Ae = document.body.querySelector("#mail"),
  fe = document.body.querySelector(".bx-envelope");
Ae.addEventListener("click", () => {
  fe.classList.toggle("bx-envelope"),
    fe.classList.toggle("bx-envelope-open"),
    document.body.querySelectorAll(".swiper-slide")[0];
});
function pe(s) {
  return (
    s !== null &&
...
function le(s, t) {
  ...
  return i.classList.add(...(Array.isArray(t) ? t : De(t))), i;
}
function qe(s, t) {
  const i = [];
...
function Pe(s) {
  return s === void 0 && (s = {}), ee || (ee = je(s)), ee;
}
let te;
function We() {
  const s = D(),
...
function Ke() {
  ...
  typeof s.params.width < "u" && s.params.width !== null
    ...
    !((t === 0 && s.isHorizontal()) || (i === 0 && s.isVertical())) &&
      ((t =
        t -
        parseInt(N(e, "padding-left") || 0, 10) -
        parseInt(N(e, "padding-right") || 0, 10)),
      (i =
        i -
        parseInt(N(e, "padding-top") || 0, 10) -
        parseInt(N(e, "padding-bottom") || 0, 10)),
      Number.isNaN(t) && (t = 0),
      Number.isNaN(i) && (i = 0),
      Object.assign(s, {
        width: t,
    ...
    if (
      ...
      if (i.slidesPerView === "auto") {
        ...
        if (
          ...
          _ = s.isHorizontal() ? ve(M, "width") : ve(M, "height");
        else {
          const C = t(P, "width"),
            V = t(P, "padding-left"),
            K = t(P, "padding-right"),
...
function tt(s) {
  ...
  for (let a = 0; a < e.length; a += 1) {
    ...
    b && (t.visibleSlides.push(d), t.visibleSlidesIndexes.push(a)),
      he(d, b, i.slideVisibleClass),
      he(d, v, i.slideFullyVisibleClass),
      (d.progress = r ? -u : u),
...
function st() {
  ...
  a &&
    (o ||
      ((c = Ne(a, `.${i.slideClass}, swiper-slide`)[0]),
      i.loop && !c && (c = t[0]),
      (d = qe(a, `.${i.slideClass}, swiper-slide`)[0]),
      i.loop && !d === 0 && (d = t[t.length - 1]))),
    t.forEach((u) => {
      ie(u, u === a, i.slideActiveClass),
        ie(u, u === c, i.slideNextClass),
        ie(u, u === d, i.slidePrevClass);
    }),
    s.emitSlidesClasses();
}
const Y = (s, t) => {
...
function nt(s) {
  ...
  if ((typeof a > "u" && (a = rt(t)), e.indexOf(i) >= 0)) d = e.indexOf(i);
  else {
  ...
  if (
    ...
    if (t === 0) l[u ? "scrollLeft" : "scrollTop"] = -c;
      ...
      if (!n.support.smoothScroll)
        return (
          Ee({ swiper: n, targetPosition: -c, side: u ? "left" : "top" }), !0
        );
...
function vt(s, t) {
  ...
  e.cssMode ||
    ...
    _e({ swiper: i, runCallbacks: s, direction: t, step: "Start" }));
}
function ht(s, t) {
  s === void 0 && (s = !0);
  const i = this,
  ...
  (i.animating = !1),
    !e.cssMode &&
      (i.setTransition(0),
      _e({ swiper: i, runCallbacks: s, direction: t, step: "End" }));
}
var gt = { setTransition: mt, transitionStart: vt, transitionEnd: ht };
function yt(s, t, i, e, r) {
  s === void 0 && (s = 0),
    i === void 0 && (i = !0),
  ...
  if (l.cssMode) {
    ...
    if (t === 0)
      ...
      if (!n.support.smoothScroll)
        return (
          Ee({ swiper: n, targetPosition: E, side: w ? "left" : "top" }), !0
        );
...
var Lt = { loopCreate: Pt, loopFix: _t, loopDestroy: It };
function kt(s) {
  const t = this;
  if (
...
var zt = { setGrabCursor: kt, unsetGrabCursor: Ct };
function At(s, t) {
  t === void 0 && (t = this);
  function i(e) {
    if (!e || e === q() || e === D()) return null;
...
function Ot(s) {
  ...
  if (e.type === "touchstart") {
    ge(t, e, e.targetTouches[0].pageX);
    return;
  }
  ...
  let a = e.target;
  if (
    (n.touchEventsTarget === "wrapper" && !Be(a, t.wrapperEl)) ||
  ...
  if (n.noSwiping && (f ? At(u, a) : a.closest(u))) {
    t.allowClick = !0;
    return;
  }
...
const Ie = (s, t) => {
  ...
  !r ||
    ...
    e.updateOnWindowResize
      ...
      : s[d]("observerUpdate", ye, !0),
    r[a]("load", s.onLoad, { capture: !0 }));
};
function qt() {
  const s = this,
    { params: t } = s;
  (s.onTouchStart = Ot.bind(s)),
    (s.onTouchMove = Dt.bind(s)),
    (s.onTouchEnd = Ft.bind(s)),
    (s.onDocumentTouchStart = Bt.bind(s)),
    t.cssMode && (s.onScroll = Vt.bind(s)),
    (s.onClick = Gt.bind(s)),
    (s.onLoad = Rt.bind(s)),
    Ie(s, "on");
}
...
var Ht = { attachEvents: qt, detachEvents: Nt };
const we = (s, t) => s.grid && t.grid && t.grid.rows > 1;
function $t() {
  const s = this,
...
var Wt = { setBreakpoint: $t, getBreakpoint: jt };
function Xt(s, t) {
  const i = [];
  return (
    s.forEach((e) => {
...
var Ut = { addClasses: Yt, removeClasses: Jt };
function Kt() {
  const s = this,
...
class G {
  constructor() {
    ...
    (l.__swiper__ = !0),
      (l.support = Me()),
      (l.device = Pe({ userAgent: i.userAgent })),
      (l.browser = Xe()),
      (l.eventsListeners = {}),
  ...
  mount(t) {
    ...
    return (
      !o &&
        ...
        ((o = le("div", i.params.wrapperClass)),
        e.append(o),
      ...
      Object.assign(i, {
        ...
        mounted: !0,
        rtl: e.dir.toLowerCase() === "rtl" || N(e, "direction") === "rtl",
        rtlTranslate:
          i.params.direction === "horizontal" &&
          (e.dir.toLowerCase() === "rtl" || N(e, "direction") === "rtl"),
  ...
  destroy(t, i) {
    ...
    return (
      typeof e.params > "u" ||
        ...
        t !== !1 &&
          (e.el && typeof e.el != "string" && (e.el.swiper = null), Fe(e)),
        (e.destroyed = !0)),
      null
    );
  }
...
Object.keys(re).forEach((s) => {
  Object.keys(re[s]).forEach((t) => {
    G.prototype[t] = re[s][t];
  });
});
G.use([Ye, Je]);
function ei(s) {
...
const ti = document.body.querySelector("#play"),
  ae = document.body.querySelector(".bx-pause-circle"),
  xe = new G(".swiper", {
    modules: [ei],
    direction: "horizontal",
    loop: !0,
...
ti.addEventListener("click", () => {
  ae.classList.toggle("bx-play-circle"),
    ae.classList.toggle("bx-pause-circle"),
    ae.classList.contains("bx-pause-circle")
      ? xe.autoplay.start()
      : xe.autoplay.stop();
});
const ce = document.body.querySelector("#sound"),
  Se = document.body.querySelector(".bx-volume-mute"),
  $ = document.querySelector(".audio");
ce.addEventListener("click", () => {
  Se.classList.toggle("bx-volume-full"),
    Se.classList.toggle("bx-volume-mute"),
    ce.classList.toggle("paused"),
    $.paused ? $.play() : $.pause();
});
window.onfocus = function () {
  ce.classList.contains("paused") ? $.pause() : $.play();
};
